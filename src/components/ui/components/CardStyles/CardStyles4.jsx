...
function CardStyles4() {
    ...
    return (
        <div className={cx('cdstl4 ')}>
            <div className={cx('cdstl4 __content')}>
                <div>
                    <img
                        loading="lazy"
                        className={cx('cdstl4 __backdrop')}
            ...
            <div className={cx('cdstl4 __movie')}>
                <div
                    className={cx('cdstl4 __title')}
                    href="/movie/830784"
                ...
                <span className={cx('cdstl4 __voteAverage')}>77%</span>
            </div>
        </div>
    );
}
